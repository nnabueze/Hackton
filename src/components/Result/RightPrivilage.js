...
class RightPrivilage extends Component {
    constructor(props) {
        super(props);
        this.state = {  };
    }
                    ...
                    <div className="col-lg-12 margin-bottom-45px">
                      <div className="padding-30px background-white full-width background-white thum-hover box-shadow hvr-float">
                        <div className="padding-30px">
                          ...
                          <div id="tor" className="margin-left-85px">
                           
                            <Link to="/landlord-right" className="btn btn-sm border-radius-30 margin-tb-15px text-white background-second-color  box-shadow float-right padding-lr-20px margin-left-30px">
                            <i className="fas fa-plus-circle" />  Landlord's Rights
                            </Link>
                            <a className="d-inline-block text-dark text-medium margin-right-20px" href="#">RIGHTS OF THE TENANT </a>
